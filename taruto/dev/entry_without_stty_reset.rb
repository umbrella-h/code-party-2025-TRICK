# THE BUG:
# I found I have to reset terminal settings to defaults, for example, by using `stty sane` command.
# Otherwise, if i ran another TRICK with a special terminal setting, the terminal will not display the output correctly.
